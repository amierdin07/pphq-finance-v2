...
const TransactionsPage: React.FC<TransactionsPageProps> = ({ type, nature = TransactionNature.Money }) => {
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <button
                onClick={() => openModal()}
                className="fixed bottom-20 md:bottom-8 right-6 md:right-8 z-40 p-4 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full shadow-2xl shadow-emerald-500/40 transition-all hover:scale-110 active:scale-95 flex items-center justify-center cursor-pointer"
